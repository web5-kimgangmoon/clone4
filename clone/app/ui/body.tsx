    ...
    <header className="w-full" ref={container}>
      <div className="relative flex flex-col items-center text-balance text-center break-keep cursor-default">
        ...
        <div className="container flex gap-4 justify-center">
          <Link
            className="flex items-center px-5 py-3 text-white bg-blue-500 hover:bg-blue-500/90 rounded-md transition-colors duration-100 font-(family-name:--font-sansation) font-[550]"
            href={"/"}
          >
            Notion 무료 다운로드
          </Link>
          <Link
            className="flex items-center px-5 py-3 text-blue-500 bg-blue-100 hover:bg-blue-100/40 rounded-md transition-colors duration-100 font-(family-name:--font-sansation) font-[550]"
            href={"/"}
          >
            영업팀 문의하기
          </Link>
