...
const Logo = () => {
  return (
    <svg fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 105 30">
      <g clipPath="url(#a)">
        <mask
          id="b"
          width="29"
      ...
      <defs>
        <clipPath id="a">
          <path fill="#fff" d="M0 0h104.229v30H0z"></path>
        </clipPath>
      </defs>
    </svg>
  );
...
const FooterNav = () => {
  return (
    <nav className="grid gap-x-12 grid-cols-4">
      {[
        {
          title: "회사 소개",
          content: [
            { title: "Notion 소개", href: "/" },
            { title: "채용", href: "/" },
            { title: "보안", href: "/" },
            { title: "서비스 상태", href: "/" },
            { title: "이용약관 및 개인정보 보호정책", href: "/" },
            { title: "개인정보 보호 권한", href: "/" },
          ],
        },
        {
          title: "다운로드",
        ...
        },
        {
          ...
          content: [
            ...
            { title: "팀", href: "/" },
            { title: "개인", href: "/" },
            { title: "더 살펴보기→", href: "/", isfittingBottom: true },
          ],
        },
      ].map((v, idx) => (
        <section key={idx}>
